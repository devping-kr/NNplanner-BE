...
public interface FoodRepository extends JpaRepository<Food, UUID> {
    ...
    @Query("SELECT f FROM Food f WHERE f.foodName LIKE %:foodName% ORDER BY LENGTH(f.foodName) ASC")
    Page<Food> findBySearchFood(@Param("foodName") String foodName, Pageable pageable);
}